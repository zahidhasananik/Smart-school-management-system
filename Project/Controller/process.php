<?php   include "../View/pages/AdminRegistration.php" ; ?>
<?php   include "../Controller/AdminRegValidation.php" ; ?>
...
if($Error==false)
{
    ...
    $connection->InsertData($conobj,"seller_reg",$Name,$Email,$User,$Password,$Phone,$Address,$Date,$gender,$usertype, $target_File, $validation);
